...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/jarallax/jquery.js":[function(require,module,exports) {
...
(function (a, b) {
  ...
  function bY(a, b, c, d) {
    if (f.isArray(b)) f.each(b, function (b, e) {
      c || bA.test(a) ? d(a, e) : bY(a + "[" + (_typeof(e) == "object" || f.isArray(e) ? b : "") + "]", e, c, d);
  ...
  f.extend({
    ...
    data: function data(a, c, d, e) {
      if (!!f.acceptData(a)) {
        ...
        if (_typeof(c) == "object" || typeof c == "function") e ? l[m][i] = f.extend(l[m][i], c) : l[m] = f.extend(l[m], c);
  ...
  f.event = {
    add: function add(a, c, d, e) {
      if (a.nodeType !== 3 && a.nodeType !== 8) {
        ...
        var j = i.events,
            _k = i.handle;
        j || (i.events = j = {}), _k || (i.handle = _k = function k(a) {
        ...
        while (l = c[m++]) {
          ...
          if (!o) {
            o = j[l] = [];
            if (!p.setup || p.setup.call(a, e, n, _k) === !1) a.addEventListener ? a.addEventListener(l, _k, !1) : a.attachEvent && a.attachEvent("on" + l, _k);
          }
    ...
    trigger: function trigger(c, d, e, g) {
      ...
      if (!!e && !f.event.customEvent[h] || !!f.event.global[h]) {
        c = _typeof(c) == "object" ? c[f.expando] ? c : new f.Event(h, c) : new f.Event(h), c.type = h, c.exclusive = j, c.namespace = i.join("."), c.namespace_re = new RegExp("(^|\\.)" + i.join("\\.(?:.*\\.)?") + "(\\.|$)");
  ...
  f.support.focusinBubbles || f.each({
    ...
    f.fn[c] = function (a, d, e) {
      ...
      c === "one" ? (_g = function g(a) {
        f(this).unbind(a, _g);
        return e.apply(this, arguments);
      }, _g.guid = e.guid || f.guid++) : _g = e;
      if (a === "unload" && c !== "one") this.one(a, d, e);else for (var i = 0, j = this.length; i < j; i++) {
    ...
    unbind: function unbind(a, b) {
      if (_typeof(a) == "object" && !a.preventDefault) for (var c in a) {
        this.unbind(c, a[c]);
  ...
  f.each(["live", "die"], function (a, c) {
    f.fn[c] = function (a, d, e, g) {
      ...
      if (_typeof(a) == "object" && !a.preventDefault) {
        for (var o in a) {
          n[c](o, d, a[o], m);
        }
      ...
      while ((h = a[i++]) != null) {
        ...
        if (c === "live") for (var p = 0, q = n.length; p < q; p++) {
    ...
    var _k3 = function k(b, d, f, g) {
      ...
      if (x.length > 1 && m.exec(b)) {
        if (x.length === 2 && l.relative[x[0]]) j = v(x[0] + x[1], d);else {
          j = l.relative[x[0]] ? [d] : _k3(x.shift(), d);
        ...
        !g && x.length > 1 && d.nodeType === 9 && !w && l.match.ID.test(x[0]) && !l.match.ID.test(x[x.length - 1]) && (q = _k3.find(x.shift(), d, w), d = q.expr ? _k3.filter(q.expr, q.set)[0] : q.set[0]);

        if (d) {
          q = g ? {
            expr: x.pop(),
            set: p(g)
          } : _k3.find(x.pop(), x.length === 1 && (x[0] === "~" || x[0] === "+") && d.parentNode ? d.parentNode : d, w), j = q.expr ? _k3.filter(q.expr, q.set) : q.set, x.length > 0 ? n = p(j) : u = !1;
      ...
      o && (_k3(o, h, f, g), _k3.uniqueSort(f));
      return f;
    };
    ...
    _k3.uniqueSort = function (a) {
      ...
      while (a && c.length) {
        ...
        if (a === h) if (g == null) _k3.error(a);else break;
        h = a;
      }
    ...
    var l = _k3.selectors = {
      ...
      preFilter: {
        ...
        CHILD: function CHILD(a) {
          if (a[1] === "nth") {
            a[2] || _k3.error(a[0]), a[2] = a[2].replace(/^\+|\s*/g, "");
            var b = /(-?)(\d*)(?:n([+\-]?\d*))?/.exec(a[2] === "even" && "2n" || a[2] === "odd" && "2n+1" || !/\D/.test(a[2]) && "0n+" + a[2] || a[2]);
            a[2] = b[1] + (b[2] || 1) - 0, a[3] = b[3] - 0;
          } else a[2] && _k3.error(a[0]);
      ...
      filter: {
        PSEUDO: function PSEUDO(a, b, c, d) {
          ...
          if (e === "contains") return (a.textContent || a.innerText || _k3.getText([a]) || "").indexOf(b[3]) >= 0;
    ...
    try {
      ...
      p = function p(a, b) {
        var c = 0,
            d = b || [];
        if (e.call(a) === "[object Array]") Array.prototype.push.apply(d, a);else if (typeof a.length == "number") for (var f = a.length; c < f; c++) {
          d.push(a[c]);
        } else for (; a[c]; c++) {
          d.push(a[c]);
        }
    ...
    var r, s;
    c.documentElement.compareDocumentPosition ? r = function r(a, b) {
      if (a === b) {
        g = !0;
        return 0;
      }
      ...
      if (b) {
        ...
        _k3.matchesSelector = function (a, c) {
          ...
          return _k3(c, null, null, [a]).length > 0;
        };
      }
    }(), function () {
      var a = c.createElement("div");
  ...
  f.fn.css = function (a, c) {
    ...
    style: function style(a, c, d, e) {
      if (!!a && a.nodeType !== 3 && a.nodeType !== 8 && !!a.style) {
        ...
        h = _typeof(d), h === "string" && (g = br.exec(d)) && (d = +(g[1] + 1) * +g[2] + parseFloat(f.css(a, c)), h = "number");
          ...
          h.send(c.hasContent && c.data || null), _d = function d(a, e) {
            ...
            try {
              if (_d && (e || h.readyState === 4)) {
                _d = b, i && (h.onreadystatechange = f.noop, cb && delete cd[i]);
    ...
    step: function step(a) {
      ...
      if (a || b >= e.duration + this.startTime) {
        ...
        if (c) {
          ...
          if (e.hide || e.show) for (var i in e.animatedProperties) {
...
},{}]},{},["../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/jarallax/jquery.js"], null)
//# sourceMappingURL=/jquery.2ffa6b51.js.map